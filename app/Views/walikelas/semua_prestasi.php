...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="<?= base_url('walikelas/dashboard'); ?>">PRESISADMIN</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="ms-auto d-flex align-items-center">
                    <span class="navbar-text text-light me-3">Walikelas</span>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url('walikelas/semua_prestasi'); ?>">Semua Prestasi</a>
                    </li>
                    <li>
                        <hr>
                    </li>
...
<script>
    function loadDetail(id_prestasi) {
        ...
        fetch(`/walikelas/detail_prestasi/${id_prestasi}`)
